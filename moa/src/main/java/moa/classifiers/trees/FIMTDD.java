...
public class FIMTDD extends AbstractClassifier implements Regressor {
	...
	// Shujie add:
	public FloatOption clfThresholdOption = new FloatOption("clfThreshold", 'X', "Classification threshold",
			0.5);
	...
	public double[] getVotesForInstance(Instance inst) {
		...
		//Shujie add: convert regression to classification
        if (prediction < 0) {
        	prediction = 0;
		}
		if (prediction > 1) {
        ...
        //if (prediction >= clfThresholdOption.getValue()) {
